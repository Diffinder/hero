        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Admin<!--Changed-->
                        <small>Customer Feedback Details</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Admin Feedback</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Feedback Details</h3>
                                ...
                                <!-- form start -->
                                    ...
                                    <div class="box-body">
                                            ...
                                            <a href="vendor_index.php">Go to Dashboard</a><!--changed-->
...
$sql = "SELECT * from feedback where f_ID='$f'";

$result = mysql_query($sql)
or die("Invalid query: " . mysql_error());
$result1=mysql_fetch_array($result);
//added
$sql = "UPDATE feedback set status='1' where f_ID='$f'";
$result = mysql_query($sql)
or die("Invalid query: " . mysql_error());

print '<script type="text/javascript">';
print 'document.getElementById("feedbackx").innerHTML="'.$f." - ".$result1['feedback'].'";';
print '</script>'; 
