                            ...
                            <div class="box box-primary">
                                ...
                                <form role="form" action ="feedback.php" method="POST">
                                    <div class="box-body">
                                            ...
                                            <textarea class="form-control" rows="3" name="feedback" placeholder="Enter your feedback here..."></textarea>
                                        </div>
...
$fb=$_POST['feedback'];
$sql = "Select feedback INTO feedback where f_ID=$_GET['fid']";
$result = mysql_query($sql)
or die("Invalid query: " . mysql_error());

print '<script type="text/javascript">';
print 'document.getElementByID("feedback").innerHTML="'.$result["feedback"].'";';
print '</script>'; 
}
