                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-red" onclick="status_update();" style="cursor:pointer;" id="status_edit">Edit</span><span class="badge bg-red" onclick="status_update();" style="cursor:pointer;display:none;" id="status_update" name="st_upd">Update</span></td>
                                            </form>
                                        </tr>
                                        <tr>
                                            <td>1.</td>
                                            ...
                                            <div>
                                            <input type="datetime-local" class="form-control " name="dd" id="dd_"  style="display:none;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <div>
                                            <input type="text" class="form-control " name="price" id="price" placeholder="1500-INR" disabled>
                                            </div>
                                            </td>
                                            <td><span class="badge bg-red" onclick="price_update();" style="cursor:pointer;" id="price_edit">Edit</span><span class="badge bg-red" onclick="price_update();" style="cursor:pointer;display:none;" id="price_update">Update</span></td>
                                        </tr>
                                    </table>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
