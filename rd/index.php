...
$t = "USER_".$ph;
    $sql = "INSERT INTO vendor_order(O_ID,CustID,Showroom,Bike,ser_cat,ser_type,order_time,req_detail,add_info,email,phone,addr,ser_mode,dd) VALUES('$tim','$t','$sr','$b','$sc','$st',CURRENT_TIMESTAMP,'$rd','$ai','$mail','$ph','$adr','$sm','$dd')";
    $result = mysql_query($sql)
    or die("Invalid query: " . mysql_error());
