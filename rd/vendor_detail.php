                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-red" onclick="status_update();" style="cursor:pointer;" id="status_edit">Edit</span><span class="badge bg-red" onclick="status_update();" style="cursor:pointer;display:none;" id="status_update">Update</span></td>
                                        </tr>
                                        <tr>
                                            <td>1.</td>
...
$query = "update vendor_order set view_status='0' WHERE O_ID='$_GET['oid']'";
